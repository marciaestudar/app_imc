...
Original file is located at
    https://colab.research.google.com/drive/1IvKb8K7gnWS9V3qiiVGZLaP3oD6IsdaC
"""
...
class CalculadoraIMC:
    def __init__(self):
        # A estrutura de classificações é excelente e será usada para a tabela
        self.classificacoes = [
            ...
            try:
                ...
                with st.container():
                    ...
                    with col_res1:
                        ...
                        # Cria um DataFrame a partir da lista de classificações da classe
                        ...
                        df_classificacoes = df_classificacoes.rename(columns={
                            ...
                            "cat": "Categoria",
                            "desc": "Descrição",
                            "cor": "Cor (Interno)" # Mantém a cor para referência, mas pode ser escondida
                        })
                        # Ajusta a coluna 'IMC Máximo' para exibir '< 18.5' e '>= 40.0' de forma mais amigável
                        df_classificacoes['IMC Máximo'] = df_classificacoes['IMC Máximo'].apply(
                            lambda x: f"< {x:.1f}" if x != float('inf') else ">= 40.0"
                        )
                        # Reordena e seleciona as colunas para exibição
