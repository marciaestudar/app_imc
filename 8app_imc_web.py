...
Original file is located at
    https://colab.research.google.com/drive/1rMT9NMWsa3tIjcZ8c8L8sFdO1ur9zhXq
"""
...
class CalculadoraIMC:
    ...
    def obter_dicas(self, classificacao, idade):
        ...
        if "Abaixo do peso" in classificacao:
            dicas.extend([
                "\n### 🥑 Estratégias para Ganho de Peso Saudável - Recomentações Médicas de Preferência:",
            ...
            dicas.extend([
                "\n### 🥦 Estratégias para Emagrecimento Saudável - Recomentações Médicas de Preferência:",
            ...
            dicas.extend([
                ...
                "- Importe nesse processo - Mantenha check-ups regulares"
            ])
            ...
            if not all([peso, altura, idade]):
                ...
                with st.container():
                    ...
                    with col_res1:
                        ...
                        # Gráfico
                        fig = px.bar(x=["Seu IMC"], y=[imc],
                                    title="Posição nas Faixas de IMC",
                                    labels={"y": "Valor do IMC"},
                                    color_discrete_sequence=["#27ae60"])
                        fig.add_hrect(y0=18.5, y1=24.9, fillcolor="#2ecc71", opacity=0.2)
